<?php
/* Smarty version 3.1.34-dev-7, created on 2020-10-04 20:34:24
  from '/var/www/html/yeti/layouts/basic/modules/Calendar/Extended/CalendarView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f7997200ce6f7_72487606',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '121e96ded31a9c459388e1a0c125534332c8eb4b' => 
    array (
      0 => '/var/www/html/yeti/layouts/basic/modules/Calendar/Extended/CalendarView.tpl',
      1 => 1597983671,
      2 => 'file',
    ),
  ),
...
function content_5f7997200ce6f7_72487606 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- tpl-Calendar-Extended-CalendarView --><input value="<?php echo \App\Purifier::encodeHtml($_smarty_tpl->tpl_vars['CURRENT_USER']->value->getDetail('activity_view'));?>
...
"type="hidden" id="hiddenDays"/><input value="<?php echo \App\Purifier::encodeHtml($_smarty_tpl->tpl_vars['ACTIVITY_STATE_LABELS']->value);?>
" type="hidden" id="activityStateLabels"/><input value="<?php echo \App\Purifier::encodeHtml(\App\Json::encode($_smarty_tpl->tpl_vars['HISTORY_PARAMS']->value));?>
...
if (!empty($_smarty_tpl->tpl_vars['HISTORY_PARAMS']->value['cvid']) && $_smarty_tpl->tpl_vars['HISTORY_PARAMS']->value['cvid'] == $_prefixVariable2) {?>true<?php } else { ?>false<?php }?>"><?php echo \App\Language::translate($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('viewname'),$_smarty_tpl->tpl_vars['MODULE']->value);
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></ul><?php }?><a class="o-calendar__clear-btn btn btn-warning d-none ml-1 js-calendar__clear-filters js-popover-tooltip" role="button" data-content="<?php echo \App\Language::translate("LBL_REMOVE_FILTERING",$_smarty_tpl->tpl_vars['MODULE']->value);?>
"data-js="class: d-none | popover"><span class="fas fa-eraser" title="<?php echo \App\Language::translate("LBL_REMOVE_FILTERING",$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></span></a></div></div><div class="js-calendar__container" data-js="fullcalendar | offset"></div></div></div><!-- /tpl-Calendar-Extended-CalendarView -->
<?php }
}
