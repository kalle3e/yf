...
/* Smarty version 3.1.34-dev-7, created on 2020-09-01 22:58:23
  from '/var/www/html/yeti/layouts/basic/modules/Vtiger/ListViewHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f4e456fb91b76_12837306',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '724afbace8bdc3d8efba51a09210a03d2267f017' => 
    array (
      0 => '/var/www/html/yeti/layouts/basic/modules/Vtiger/ListViewHeader.tpl',
      1 => 1597983671,
      2 => 'file',
    ),
  ),
...
function content_5f4e456fb91b76_12837306 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div><div class="customFilterMainSpan ml-auto mx-xl-auto"><?php if (count($_smarty_tpl->tpl_vars['CUSTOM_VIEWS']->value) > 0) {?><select id="customFilter" class="form-control" title="<?php echo \App\Language::translate('LBL_CUSTOM_FILTER');?>
"><?php
...
" <?php echo ' ';?>
data-featured="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isFeatured();?>
...
"<?php if ($_smarty_tpl->tpl_vars['GROUP_LABEL']->value != 'Mine' && $_smarty_tpl->tpl_vars['GROUP_LABEL']->value != 'System') {?>data-option="<?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getOwnerName();?>
...
?></div></div></div><?php if (count($_smarty_tpl->tpl_vars['CUSTOM_VIEWS']->value) > 0) {?><ul class="c-tab--border nav nav-tabs" role="tablist"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['CUSTOM_VIEWS']->value, 'GROUP_CUSTOM_VIEWS', false, 'GROUP_LABEL');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['GROUP_LABEL']->value => $_smarty_tpl->tpl_vars['GROUP_CUSTOM_VIEWS']->value) {
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['GROUP_CUSTOM_VIEWS']->value, 'CUSTOM_VIEW');
...
" data-js="click"><a class="nav-link<?php if ($_smarty_tpl->tpl_vars['VIEWID']->value == $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getId()) {?> active<?php }?>" href="#"<?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('color')) {?>style="color: <?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('color');?>
; border-color: <?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('color');?>
 <?php echo $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('color');?>
 #fff"<?php }?>data-toggle="tab" role="tab"aria-selected="<?php if ($_smarty_tpl->tpl_vars['VIEWID']->value == $_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->getId()) {?>true<?php } else { ?>false<?php }?>"><?php echo \App\Language::translate($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->get('viewname'),$_smarty_tpl->tpl_vars['MODULE']->value);
