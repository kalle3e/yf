...
class Calendar
{
	...
	/** Show calendar timeline in monthly view:  false = basicWeek, true = agendaWeek */
	public static $SHOW_TIMELINE_WEEK = true;

	/** Show calendar timeline in day view: false = basicDay, true = agendaDay */
	...
	public static $CRON_MAX_NUMBERS_ACTIVITY_STATS = 5000;
