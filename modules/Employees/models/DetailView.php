...
class Employees_DetailView_Model extends Vtiger_DetailView_Model
{
	...
	public function getDetailViewLinks($linkParams)
	{
		...
		$linkURL = 'index.php?module=Employees&view=EmployeeHierarchy&record=' . $recordModel->getId();
		$linkModel = [
			'linktype' => 'LISTVIEWMASSACTION',
			'linkhint' => 'LBL_SHOW_EMPLOYEES_HIERARCHY',
			'linkurl' => 'javascript:Employees_Detail_Js.triggerEmployeeHierarchy("' . $linkURL . '");',
